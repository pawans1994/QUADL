...
class TextboxXBlock(XBlock):
    ...
    def student_view(self, context=None):
        """
        The primary view of the TextboxXBlock, shown to students
    ...
    def get_student_id(self, data, suffix=''):
        ...
        self.xblock_id = str(self.scope_ids.usage_id)
