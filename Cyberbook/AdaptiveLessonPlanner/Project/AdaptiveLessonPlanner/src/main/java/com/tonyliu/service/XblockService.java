...
public class XblockService {
    ...
    public Double saveStudentProbability(String studentId, String skillname, String correctness, String questionId, String course) {
        ...
        try {
            ...
            int count = getOpportunityCount(studentId,skillname);
            double prevL = getProbability(studentId,skillname);
    ...
    public double getProbability(String studentId,String skillname){
    	double prevL = 0.0;
    ...
    public int getOpportunityCount(String studentId, String skillname){
    	int count = 0;
    	String sql = "select * from edxapp_csmh.temporary_probability where student_pastel_id = ? and skillname = ?";
        try {
