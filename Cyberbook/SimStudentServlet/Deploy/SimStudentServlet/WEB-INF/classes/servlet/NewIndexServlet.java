...
public class NewIndexServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String bundle = "/Users/simstudent/tomcat/webapps/SimStudentServlet/WEB-INF/classes/";
		String bundleName;
		String brdFileName = "";
		String wmeFileName = "";
		if((bundleName = request.getParameter("brdSelect"))!=null){
			...
			response.sendRedirect("http://localhost:8080/SimStudentServlet/tutor.html?BRD=http%3A%2F%2Flocalhost%3A8080%2FSimStudentServlet%2F"+brdFileName+"&ARG=-traceOn+-folder+"+bundleName+"+-problem+"+wmeFileName+"+-ssTypeChecker+"+bundleName+".MyFeaturePredicate.valueTypeChecker&CSS=&INFO=&BRMODE=AuthorTimeTutoring&AUTORUN=on&KEYBOARDGROUP=Disabled&BACKDIR=http%3A%2F%2Fkona.education.tamu.edu%3A2401%2FSimStudentServlet%2Fbuild%2Fclasses&BACKENTRY=interaction.ModelTracerBackend&PROBLEM=xxx&DATASET=FlashLoggingTest_xxx&LEVEL1=Unit1&TYPE1=unit&USER=qa-test&GENERATED=on&SOURCE=PACT_CTAT_HTML5&USEOLI=false&SLOG=true&LOGTYPE=None&DISKDIR=.&PORT=4000&REMOTEURL=serv&SKILLS=&VAR1=xxx_xxx&VAL1=xxx&VAR2=xxx_xxx&VAL2=xxx&VAR3=xxx_xxx&VAL3=xxx&VAR4=xxx_xxx&VAL4=xxx&submit=Launch+HTML5+Tutor");
