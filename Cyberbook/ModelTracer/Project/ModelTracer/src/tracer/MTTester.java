...
//		System.out.println(tracer.sendSAI(sai4));
		...
		MTSolver tracer = new MTSolver("tracer/init.wme", "tracer/wmeTypes.clp", "tracer/productionRules.pr");
		MTResult result;
        MTSAI sai1 = new MTSAI("dorminTable3_C1R1","UpdateTextField","multiply 4");
        result = tracer.sendSAI(sai1);
        System.out.println(" Result : "+result.getType()+ " Skillname : "+result.getRuleFired());
        System.out.println("");
        System.out.println("Hint : "+tracer.getHint());
        System.out.println(" x ");
        MTSAI sai2 = new  MTSAI("dorminTable1_C1R2","UpdateTextField","x");
        result = tracer.sendSAI(sai2);
        System.out.println(" Result : "+result.getType()+ " Skillname : "+result.getRuleFired());
        System.out.println(" 48 ");
        MTSAI sai3 = new  MTSAI("dorminTable2_C1R2","UpdateTextField","48");
        result = tracer.sendSAI(sai3);
        System.out.println(" Result : "+result.getType()+ " Skillname : "+result.getRuleFired());
        System.out.println(" done ");
        MTSAI sai4 = new  MTSAI("done","ButtonPressed","-1");
        result = tracer.sendSAI(sai4);
        System.out.println(" Result : "+result.getType()+ " Skillname : "+result.getRuleFired());
