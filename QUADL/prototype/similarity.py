...
with BertClient() as bc:
    with open('target_sentence.csv','w') as fp:
        wr = csv.writer(fp)
        header = ['unit','module','sentence','learning objective','start','end','answer','score']
        wr.writerow(header)
        ...
        for um in unitmodule:
            ...
            for lo_vec in lo_vecs:#for each learnign obejctive
                ...
                learningobj = LOs[um][i]#before embedding of lo_vec 
                ...
                for ans in ans_sentences.keys():
                    ...
                    outputline = [unit,module,bestsentence,learningobj,startlist,endlist,ans,bestscore]
