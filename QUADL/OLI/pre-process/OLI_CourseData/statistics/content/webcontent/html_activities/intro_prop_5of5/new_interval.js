...
button.on("click", function(){
  ...
  if(document.getElementById("confidence").selectedIndex == 0){
    confidence = 1.28/3.5;
  }
  if(document.getElementById("confidence").selectedIndex == 1){
    confidence = 1.65/3.5;
  }
  if(document.getElementById("confidence").selectedIndex == 2){
    confidence = 1.96/3.5;
  }
  if(document.getElementById("confidence").selectedIndex == 3){
    confidence = 2.57/3.5;
  }
