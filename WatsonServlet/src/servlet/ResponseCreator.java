...
//		System.out.println("Response message length: " + responses.length);
	...
	public static String createTutorPerformedResponseSkill(String skillname, int count){
		TutorPerformResponse resp = new TutorPerformResponse();
		resp.setMessageType("SkillMessage");
		resp.setSkillname(skillname);
		resp.setSkillCount(count);
		return createXML(new ResponseMessage[]{resp});
	}
	public static String createTutorPerformedResponseSkill(String skillname){
		TutorPerformResponse resp = new TutorPerformResponse();
		resp.setMessageType("SkillMessage");
		resp.setSkillname(skillname);
	...
	public static String createTutorPerformedResponseProblemList(String problemName){
		TutorPerformResponse resp = new TutorPerformResponse();
		resp.setMessageType("ProblemMessage");
		resp.setProblemName(problemName);
		return createXML(new ResponseMessage[]{resp});
	}
}
