 ...
 * @version 1.0
 */
package Vishnu.APLUS;

import jess.*;
import edu.cmu.pact.jess.*;
import edu.cmu.pact.miss.userDef.algebra.*;
import edu.cmu.pact.miss.userDef.algebra.weak.Difference;
import edu.cmu.pact.miss.userDef.algebra.weak.FirstNumber;
import edu.cmu.pact.miss.userDef.algebra.weak.GetFirstNumberWithSign;
import edu.cmu.pact.miss.userDef.algebra.weak.GetNumbers;
import edu.cmu.pact.miss.userDef.algebra.weak.GetNumbersAndSigns;
import edu.cmu.pact.miss.userDef.algebra.weak.NumOpNum;
import edu.cmu.pact.miss.userDef.algebra.weak.Sum;
