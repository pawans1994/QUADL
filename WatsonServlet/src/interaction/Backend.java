...
public abstract class Backend {
	...
	public void addComponent(InterfaceAttribute ia){
		System.out.println(" InterfaceAttribute to be added : "+ia);
		if(components == null){
	...
	public void sendSkillMessage(String skill, int count){
		servlet.sendSkillCountMessage(skill, count, session);
	}
	
	
	public void sendSkillMessage(String skill){
		servlet.sendSkillMessage(skill,session);
	}
	
	public void sendProblemMessage(String problem){
		servlet.sendProblemMessage(problem, session);
	}
	/**
